    ...
    <main className="mentions-page">
      ...
      <section className="mentions-container">
        ...
        <p>
          ...
          l&lsquo;identification des personnes physiques auxquelles elles
          s&lsquo;appliquent » (article 4 de la loi n° 78-17 du 6 janvier 1978).
        </p>
        <p>
        ...
        <p>
          <strong>Propriétaire</strong> : Gihozo Nathalie – 2 rue paul gauguin
          91600 Savigny-sur-orge
        </p>
        <p>
          <strong>Responsable publication</strong> : Gihozo Nathalie –
          giginatty20@gmail.com Le responsable publication est une personne
          physique ou une personne morale.
          <strong>Webmaster</strong> : Gihozo Nathalie – giginatty20@gmail.com
          <strong>Hébergeur</strong> : Vercel / Render – Paris 75016 Paris -
          <strong>Délégué à la protection des données</strong> : Gihozo Nathalie
          – giginatty20@gmail.com
        </p>
        <p>
        ...
        <h2>
          2️⃣ Conditions générales d&apos;utilisation du site et des services
          proposés.
        </h2>
        <p>
        ...
        <p>
          ...
          professionnels indépendants. Aucun lien de subordination n&apos;existe
        ...
        <p>
          ...
          nécessaire aux finalités du traitement et conformément aux obligations
          légales en vigueur.
        </p>
        ...
        Gihozo Nathalie – DPO, Gihozo Nathalie 2 rue paul gauguin 91600
        Savigny-sur-orge.
        <p>
        ...
        <p>
          ...
          aux obligations qui sont imposées à https://go-find.vercel.app/ par la
          loi, notamment en matière de conservation ou d&apos;archivage des
          documents. Enfin, les Utilisateurs de https://go-find.vercel.app/
