...
const { register, login, getAllClients, updateClient, deleteClient, getClientById } = require("../controllers/authController");
...
}, updateClient); //seul le client et l'admin peut modifier son compte 
